...
states = {
	...
	attack: {
		...
		onenter: function(this) { with(this) {
			yspeed += JUMP
			play_sfx(sfx_kick);
			bullet_spawn_ext(bullet_fading, 0.25, DAMAGE, image_angle + 0, 150, 0, image_xscale, 2, true, true, c_white, spr_spike); 
			bullet_spawn_ext(bullet_fading, 0.25, DAMAGE, image_angle + 180, 150, 0, image_xscale, 2, true, true, c_white, spr_spike); 
		}}
	}
}
aim = 0;
