...
states = {
	...
	attack: {
		duration: 2,
		onenter: function(this) { with(this) {
			xspeed += SPEED * 5 * dcos(aim);
			play_sfx(sfx_kick);
			bullet_spawn_ext(bullet_fading, 2, DAMAGE, aim, 240, 0, image_xscale, 2, true, true, c_white, spr_spike); 
		}},
		onstep: function(this, t) { with (this) { xspeed = lerp(xspeed, 0, 0.05); }}
	}
}
aim = 0;
SPEED = 120;
